<template>
    <div class="container">
        <div class="">
            <h1>Chemical: {{currentChemical.name}}</h1>
...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-details" role="tabpanel" aria-labelledby="nav-details-tab">
      <div class="container">
      <p><strong> ID: </strong>{{currentChemical.idp}}</p>
      <p><strong>Name: </strong>{{currentChemical.name}}</p> 
      <p><strong>Type:  </strong>{{currentChemical.type}} </p>
